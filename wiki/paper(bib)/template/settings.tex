...
%修改摘要
\usepackage{abstract}
\newcommand{\heiabstract}{\noindent{\xiaosi\selectfont\bfseries Abstract：}}
\newcommand{\heikeyword}{\noindent{\xiaosi\selectfont\bfseries Keywords：}}
\renewcommand{\abstractname}{\sihao\bfseries Abstract}
...
\usepackage{fancyhdr}
\pagestyle{fancy}
\newcommand{\makeheadrule}{	\rule[6pt]{\textwidth}{0.5pt}}
%\newcommand{\makeheadrule}{	\rule[6pt]{\textwidth}{0.5pt} \\[-17.5pt]
%	\rule{\textwidth}{0.5pt}}%双线页眉
%\renewcommand{\headrule}{\vbox to 5pt{\hbox to\headwidth{\hrulefill}\vss}}
\renewcommand{\headrule}{
	{\if@fancyplain\let\headrulewidth\plainheadrulewidth\fi
		\makeheadrule}}
%\newcommand{\thetitle}{\makeatletter\@title\makeatother}
%\lhead{\heiti 这里还没弄好}%\thetitle
\fancyhead[L]{\scriptsize \textsf{ACADEMIC INTEGRITY INFLUENCED BY ARTIFICIAL INTELLIGENCE: A NARRATIVE REVIEW}}
\fancyfoot[C]{}
\fancyhead[R]{\thepage}
