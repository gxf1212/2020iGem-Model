...
% var2=linspace(Pf/4,Pf/4*5,num1); % Pf
var1=linspace(rn*0.6,rn*1.5,num1); % rn
var2=linspace(rp*1,rp*10,num2);

% var1=linspace(n1*0.1,n1*2,num1); % n1
% var2=linspace(n2*0.1,n2*2,num1);
% num1=10;num2=10;
% var1=linspace(n1*0.05,n1*0.5,num1); % Nf1
% var2=linspace(n2*0.05,n2*0.5,num1);
...
for i=1:num1
    for j=1:num2
        evaluate(i,j)=[biomass(i,j,1) biomass(i,j,2) var1(i) var2(j)]*coef;
    end
end
